...
# plotMarker()
dorm_location = [25.04270341863379, 121.55933673901106]
folium.Circle(tuple(location), radius=300, popup="ucom", fill_color="#C0FFEE").add_to(map_osm)
folium.CircleMarker(tuple(dorm_location), radius=100, popup="taipei dorm", fill_color="#FFC0EE").add_to(map_osm)
